...
BEGIN
    ...
    VALUES (N'20260505153849_InitialCreate', N'9.0.16');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260506184515_AddOrderCreatedBy', N'9.0.16');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260506185436_AddMerchantOrderDraft', N'9.0.16');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260508204647_AddMerchantToOrder', N'9.0.16');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260515161555_AddParticipantToOrderLine', N'9.0.16');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260516143930_AddParticipantTokenAndDraftParticipant', N'9.0.16');
END;
