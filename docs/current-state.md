...
| Opret ordre (3-trins wizard) | ⚠️ | UC-03 trin 1 og UC-04 trin 2 er implementeret: låst merchant + dynamiske deltagere samt titel/besked med validering, tegntællere og bevaret state. Trin 3 bruger eksisterende indhold indtil UC-05. |
