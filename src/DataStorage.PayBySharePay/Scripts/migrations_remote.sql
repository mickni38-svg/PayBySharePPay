...
BEGIN
    ...
    VALUES (N'20260505153849_InitialCreate', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260506184515_AddOrderCreatedBy', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260506185436_AddMerchantOrderDraft', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260508204647_AddMerchantToOrder', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260515161555_AddParticipantToOrderLine', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260516143930_AddParticipantTokenAndDraftParticipant', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260516151034_AddMessageIsRead', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260524060213_AddParticipantPasswordHash', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260525082640_AddParticipantPaymentAndEventLog', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260628134839_AddRawMerchantPayloadJson', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260628175137_AddVippsMerchantSerialNumber', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260628193159_AddMerchantVippsCredentials', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260703193037_AddParticipantExternalLogin', N'9.0.17');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260703201732_AddVippsTestUserId', N'9.0.17');
END;
