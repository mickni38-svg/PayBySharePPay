...
public class ParticipantService : IParticipantService
{
    ...
    public async Task<ParticipantDto> CreateMerchantAsync(CreateMerchantDto dto)
    {
        ...
        var participant = new Participant
        {
            ...
            VippsClientId = NullIfWhiteSpace(dto.VippsClientId),
            VippsClientSecret = NullIfWhiteSpace(dto.VippsClientSecret),
            VippsSubscriptionKey = NullIfWhiteSpace(dto.VippsSubscriptionKey),
